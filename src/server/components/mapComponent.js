...
export default class Map extends Component {
  ...
  displayForPlayer() {
    ...
    <g class="destination" id="village">
    ...
    <g class="destination" id="mountain">
    ...
    <g class="destination" id="seaport">
